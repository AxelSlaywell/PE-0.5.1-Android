...
class FreeplayState extends MusicBeatState
{
	...
	function changeDiff(change:Int = 0)
	{
		...
		if (songs[curSelected].songName.toLowerCase() == 'training-with-gf' || songs[curSelected].songName.toLowerCase() == 'why-just-why')
			limit = 3;
		else if (StoryMenuState.weekUnlocked[3] && FlxG.save.data.remixUnlocked != null)
			limit = 4;
